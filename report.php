...
$rid=$_GET['rid'];
    ...
    $sql = "SELECT * FROM reports WHERE report_id = $rid"; // SQL query to select 'photo' based on 'id'
...
<html>
    <head>
        ...
        <title>Reports - Wellness Web</title>
        ...
        <script>
            ...
            function back(){
                window.location.href='reportList.php?id=<?php echo $id;?>';
            }
        </script>
        <style>
        body {
        ...
        <div class="page-wrapper">
                        ...
                        <div class="navbar-content d-flex justify-content-between align-items-center">
                            ...
                            <div class = "navbar-box">
                                ...
                                <ul class = "navbar-nav d-flex align-items-center">
                                    <li class = "nav-item">
                                        <a href = "#" class = "nav-link text-white nav-active text-nowrap">Report</a>
                                    </li>
                                    <li class = "nav-item">
            ...
            <div class="prescription-details">
                <table>
                    <tr>
                        <th>Report ID</th>
                        <td id="prescription-id"><?php echo $rid;?></td>
                    </tr>
                    <tr>
                        <th>Patient ID</th>
                    ...
                    <tr>
                        ...
                        <td id="medicines"><?php echo $date;?></td>
                    </tr>
                    <tr>
                        <th>Sample Collection Time</th>
                        <td id="advices"><?php echo $time;?></td>
                    </tr>
                    <tr>
                        <th>Disease</th>
