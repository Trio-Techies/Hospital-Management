...
$sql = "SELECT distinct state FROM emergency order by state";
                ...
                <div class = "services-shape">
                    ...
                    <div class="container">
                        <div class = "services-content">
                            ...
                            <center>
                            <form method="post" class="form" action="emergency_contacts.php?id=<?php echo $id;?>">
                                <input type="radio" id="option1" name="choices" value="Zip" required>
                                <center><label for="option1">Select By Zip Code</label></center>
                                <input type="radio" id="option2" name="choices" value="State" required>
                                <center><label for="option2">Select By District</label></center>
                                <label for="zip"><b>Zip Code:</b></label>
                                <input type="text" id="zip" name="zip" placeholder="Enter Zip Code To Search">
                                <br><center><h3 style="margin-top:20px;"><b>OR</b></h3></center><br>
                                <label for="state"><b>Select State:</b></label>
                                <select id="state" name="state" onchange="showDistrict()">
...
<script>
    function showDistrict() {
        ...
        xhr.open("GET", "get_districts.php?state=" + state, true);
        xhr.send();
    }
</script>
