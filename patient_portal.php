...
<html>
    <head>
        ...
        <title>Patient Portal - Wellness Web</title>
                        ...
                        <div class="navbar-content d-flex justify-content-between align-items-center">
                            ...
                            <div class = "navbar-box">
                                ...
                                <ul class = "navbar-nav d-flex align-items-center">
                                    <li class = "nav-item">
                                        <a href = "#" class = "nav-link text-white nav-active text-nowrap">Patient Portal</a>
                                    </li>
                                    <li class = "nav-item">
                        ...
                        <div class = "services-content">
                            <div class="title-box text-center">
                                <div class = "content-wrapper">
                                    <h3 class = "title-box-name">Patient Portal</h3>
                                    <div class = "title-separator mx-auto"></div>                                    
                                </div>
                            </div>
                            <center>
                            <div class = "services-list">
                                <div class = "services-item" style="width: 270px; height: 300px;">
                                    <div class = "item-icon">
                                        <img src = "img/images/service-icon-4.png" alt = "service icon">
                                    </div>
                                    <h5 class = "item-title fw-7">Patient Profile</h5>
                                    <div class = "d-flex align-items-center justify-content-center services-main-btn">
                                <button type = "button" class = "btn btn-primary-outline" onclick="window.location.href = 'profile.php?id=<?php echo $id?>';">Visit</button>
                            </div>
                                </div>
                                ...
                                <div class = "services-item" style="width: 270px; height: 300px;">
                                    ...
                                    <h5 class = "item-title fw-7">Your Appointments</h5>
                                    <div class = "d-flex align-items-center justify-content-center services-main-btn">
                                <button type = "button" class = "btn btn-primary-outline" onclick="window.location.href = 'appointmentList.php?id=<?php echo $id?>';" style="margin-top: -35px;">Visit</button>
                            </div>
                                </div>
                                ...
                                <div class = "services-item" style="width: 270px; height: 300px;">
                                    ...
                                    <h5 class = "item-title fw-7">Your Prescriptions</h5>
                                    <div class = "d-flex align-items-center justify-content-center services-main-btn">
                                <button type = "button" class = "btn btn-primary-outline" onclick="window.location.href = 'prescriptionList.php?id=<?php echo $id?>';"  style="margin-top: -34px;">Visit</button>
                            </div>
                                </div>
                                ...
                                <div class = "services-item" style="width: 270px; height: 300px;">
                                    ...
                                    <h5 class = "item-title fw-7">Your Reports</h5>
                                    <div class = "d-flex align-items-center justify-content-center services-main-btn">
                                <button type = "button" class = "btn btn-primary-outline" onclick="window.location.href = 'reportList.php?id=<?php echo $id?>';" style="margin-top: 5px;">Visit</button>
                            </div>
                                </div>
